...
<body>
<form id="form1" name="form1" method="get" action="AddRating" >
...
<tr> 
  <td height="700" align="center" valign="middle" bgcolor="#DFE2DB" class="Search"><table width="1038" height="588" border="0">
      <td width="438"><table width="416" height="571" border="0" class="posit">
          ...
          <td width="405" height="95"><table width="308" height="85" border="0">
            ...
            <tr>
              ...
              <td width="288"><label>Name :<br />
                <input type="text" name="name" id="name" readonly="readonly" value="<%=request.getAttribute("name")%>" class="txt"   style="border:none"/>
                </label></td>
            </tr>
            <tr>
              <td><label>University :<br />
                <input type="text" name="university" id="university" readonly="readonly" value="<%=request.getAttribute("university")%>" class="txt"   style="border:none"/>
                </label></td>
            </tr>
            <tr><td><label>Course :<br />
              <input type="text" name="course" id="course" readonly="readonly" value="<%=request.getAttribute("course")%>" class="txt"   style="border:none"/></label></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
         <td height="270"><table width="361" height="250" border="0">
            <tr>
            ...
            <tr>
              <td height="55" align="left"> <div>&nbsp;&nbsp; Helpfulness</div>
      ...
      <table width="590" height="230" border="0" class="jumbotron">
        <tr>
          <td width="224" height="40" align="center">
            <%=obj.getDate()%></td><td width="356">Tags          
                   
            <p class="style7"><%=sb%></p></td>
        </tr>
        <tr>
          <td height="42" align="center"><table width="174" height="34" border="0">
              <tr>
                ...
                <td width="108" align="center"><span class="style7">Helpfulness</span></td>
              </tr>
          </table></td>
          <td rowspan="4" align="center" valign="top">Comments
              <p class="style7"> <%=obj.getComment() %> </p></td>
        </tr>
        <tr>
          <td height="45" align="center"><table width="174" height="34" border="0">
              <tr>
                ...
                <td width="108" align="center" class="style7">Knowledgeable</td>
              </tr>
          </table></td>
        </tr>
        <tr>
