...
<body>
<form id="form1" name="form1" method="post" action="forgetPassword" >
<table width="100%" height="918" border="0" >
<tr><td><%@ include file="header.jsp" %></td></tr>
<tr> 

  <td height="500" align="center" valign="middle" class="Search" bgcolor="#DFE2DB"><table width="337" height="800" border="0" align="center" cellpadding="0" cellspacing="0" style="	style=border-collapse:collapse;" class="style14">
  
  <tr><td width="367"><table width="328" border="0" align="center" 
  class="jumbotron" >
...
<c:if test="${!empty error}">
    ...
    <tr>
      <td width="322" height="23" align="center">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td align="center"><label class="style5">Enter Below Given Details</label></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
   ...
   <tr>
      <td align="center" class="style11"> User name</td>
              ...
              <td width="322" align="center">
                <input type="text" name="userid" id="userid" class="rcorners13" required pattern="[A-Za-z0-9]{5,20}" title="Must contain alphabets & numbers only. Min length is 5 and max length is 20." maxlength="20"/>  </td>
           </tr>
            <tr>
      <td align="center">&nbsp;</td>
    </tr>
          ...
          <input name="SignIn" type="submit" class="bcolour" id="SignIn" value="ChangePassword" size="20" onmouseover="this.style.color = 'white'" onmouseout="this.style.color = '#3b3a36'" />
      	  </label></td>
     		 </tr>
