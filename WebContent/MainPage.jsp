...
<body>
<form id="form1" name="form1" method="get" action="ViewRating" >
...
<c:if test="${!empty error}">
      ...
      <tr>
        <td align="center"><input  placeholder="Enter name..." type="text" name="search" id="search" class="search SearchAzax" align="middle" size="70" class="SearchAzax" /></td>
      </tr>
      <tr>
        ...
        <td height="101" align="center"><table width="407" height="83" border="0">
            ...
            <td align="center"><div class="col-md-4 col-sm-8">
                            <div class="service-item">
                               ...
                               <button type="button" class="btn btn-success" onclick="window.location = 'Login?action=add'" >ADD A<br />
                GROUP MATE</button>
                            </div>
                        </div></td>
             <td align="center"> 
             <div class="col-md-4 col-sm-8">
               ...
               <button type="button" class="btn btn-success" onclick="window.location = 'Login?action=rate'" >RATE A <br />
