...
public class SignUp extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(FirstName != null  && LastName != null  && Password != null  && UserName != null && que != null &&	ans != null &&email != null &&
				Department != null && UniName != null){
			
			Customer c=new Customer("customer",FirstName,LastName ,Department,UniName,UserName,Password, 
					que,ans,email,Long.parseLong(PhoneNumber));			
			...
			if(customer.getFirstName()==null)
				try {
					...
					request.setAttribute("error"," User Signed up successfully !. Please login.");
				} catch (Exception e) {
